                            ...
                            <table class=" table table-bordered display nowrap fixed" id="" style="font-size: 16px;">
                                ...
                                <tbody>
                                    ...
                                    if ($_SESSION['Level'] == 'Petugas') {
                                        ...
                                        $sql = mysqli_query($konek, "SELECT * FROM penarikan INNER JOIN anggota USING(ID_Tabungan) WHERE ID_Tabungan = '$da[ID_Tabungan]' AND Status_Penarikan = 'Konfirmasi' ORDER BY ID_Penarikan ASC");
                                    }
                                    ...
                                    ?>
                                        <tr style="<?= $color; ?>">
                                            ...
                                            <?php if ($_SESSION['Level'] == 'Petugas') { ?>
                                                <td align="center">
                                                    <a href="acc_penarikan.php?act=acc&ID_Penarikan=<?= $ps['ID_Penarikan'] ?>" data-toggle="tooltip" data-placement="top" title="Konfirmasi"><button class="btn btn-icon btn-outline-primary"><i class='fa fa-check'></i></button></a> |
                                                    <a href="hapus_penarikan.php?ID_Penarikan=<?= $ps['ID_Penarikan'] ?>" data-toggle="tooltip" data-placement="top" title="Hapus" class="btn-del"><button class="btn btn-icon btn-outline-danger"><i class='fa fa-trash'></i></button></a>
                                                </td>
                                            <?php } ?>
                                        </tr>
                                    <?php
